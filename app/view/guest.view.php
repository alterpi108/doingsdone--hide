<?= renderTemplate('partials/header', ['title' => 'Дела в порядке', 'overlay' => $loginModal]) ?>
    ...
    <div class="container">
        ...
        <div class="content">
            <section class="welcome">
                ...
                <a class="welcome__button button" href="/signup">Зарегистрироваться</a>
            </section>
        </div>
    </div>
</div>

<?php if ($loginModal) echo renderTemplate('partials/login-modal',
    ['firstLogin' => $firstLogin, 'value' => $value, 'valid' => $valid, 'loginFailed' => $loginFailed]); ?>
